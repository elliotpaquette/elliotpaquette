#This script will generate a Poisson Voronoi 
#diagram.  The output will be on stdout as an .svg file

# Written by Elliot Paquette, 2021
...
#with law given by hyperbolic area measure
...
dpp = HyperbolicPoints(N,0.999)
#dpp = HyperbolicPoints(N,0.99)
...
for i in range(0,len(dpp)):#range(0,len(dpp)):
